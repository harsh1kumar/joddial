#############################################################################
# Makefile for building: joddial
# Generated by qmake (3.0) (Qt 5.2.0)
# Project:  joddial.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile joddial.pro
#############################################################################
...
Makefile: joddial.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/joddial1.0.0 || mkdir -p .tmp/joddial1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/joddial1.0.0/ && $(COPY_FILE) --parents joddial.h .tmp/joddial1.0.0/ && $(COPY_FILE) --parents main.cpp joddial.cpp .tmp/joddial1.0.0/ && (cd `dirname .tmp/joddial1.0.0` && $(TAR) joddial1.0.0.tar joddial1.0.0 && $(COMPRESS) joddial1.0.0.tar) && $(MOVE) `dirname .tmp/joddial1.0.0`/joddial1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/joddial1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_joddial.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_joddial.cpp
moc_joddial.cpp: /usr/include/qt/QtWidgets/QWidget \
...
joddial.o: joddial.cpp joddial.h \
		/usr/include/qt/QtWidgets/QWidget \
		/usr/include/qt/QtWidgets/qwidget.h \
		/usr/include/qt/QtGui/qwindowdefs.h \
		/usr/include/qt/QtCore/qglobal.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o joddial.o joddial.cpp

moc_joddial.o: moc_joddial.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_joddial.o moc_joddial.cpp
