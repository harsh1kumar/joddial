#############################################################################
# Makefile for building: build/joddial
...
build/moc_joddial.cpp: /usr/include/qt/QtWidgets/QWidget \
...
build/joddial.o: src/joddial.cpp src/joddial.h \
